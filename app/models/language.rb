class Language < ApplicationRecord
  has_many :japaneses, dependent: :nullify

  has_many :has_first_langs, class_name: "Foreigner", foreign_key: 'flng_id', dependent: :nullify
  ...
  has_many :has_second_langs, class_name: "Foreigner", foreign_key: 'slng_id', dependent: :nullify
